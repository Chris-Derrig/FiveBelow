        ...
        private static List<Product> productList = new List<Product>()
            {
                ...
                { new Product ("C","Sander's Hot Fudge Sundae","Food", 4.09, 10, "Very Cold") },
                { new Product ("D","Greek Salad with Chicken","Food", 4.99, 10, "Healthy food") },
                { new Product ("E","Detroit Style Deep Dish","Food", 3.99, 10, "Really Greasy") },
                { new Product ("F","Minesweeper Game", "Toys", .99, 10, "Designed for you to lose") },
                { new Product ("G","Star Wars Lego MiniFiguers", "Toys", 3.99, 10, "Join the Dark Side") },
